...
//             console.log("Succes in reading all users");
//         }
//     })
// }
...
exports.findOne = async(req, res) => {
    ...
    try {
        ...
        console.log('Success in reading current user');
    } catch (err) {
        res.status(400).json({
            status: false,
            data: err
        ...
        console.log('Problem in reading a user with username');
    }
}
...
exports.update = async(req, res) => {
    ...
    try {
        // new: true is an option for creating the user if not exists (using findOneAndUpdate)
